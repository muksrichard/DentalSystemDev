 ...
 <?php
  ...
  ?>
 <div class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="refresh">
   <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <!-- Nav Item - Dashboard -->
     <li class="nav-item ">
       <a class="nav-link" href="aappointments.php">
     ...
     <!-- Nav Item - Tables -->
     <li class="nav-item">
       <a class="nav-link" href="aconsultation.php">
     ...
     <!-- Nav Item - Tables -->
     <li class="nav-item">
       <a class="nav-link" href="ainvoices.php">
     ...
     <!-- Nav Item - Tables -->
     <li class="nav-item">
       <a class="nav-link" href="abilling.php">
         <i class="fa fa-database fa-fw" aria-hidden="true"></i>
         <span>Payment </span></a>
     </li>
