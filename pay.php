...
while ($row0 = $result0->fetch_assoc()) {
    ...
    $phonenum = $row0['phonenum'];
    //echo $row0['id']; 
}

$d_id=$_GET['d_id'];
// Loading users with patient role
$sql1 = "SELECT id,fullname FROM users WHERE user_type='dentist' AND id='$d_id'";
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-10 col-lg-8"><?php include('includes/taction.php'); ?>
                    ...
                    <form method="post" action="depologic.php" enctype="multipart/form-data" class="card card-sm">
                        ...
                        <input type="hidden" name="a_id" value=<?= $j_id=$_GET['pay'];; ?>>
                        ...
                        <div class="col">
                            ...
                            <div class="card-body row no-gutters align-items-center">
                                ...
                                <h5 class="text text-gray-800">Amount:</h5>
                                <input class="form-control form-control-borderless text-dark" type="number" name="amount" value="1000">
                                

                                <h5 class="text text-gray-800">Phone number:</h5>
                                <input class="form-control form-control-borderless text-dark" type="number" name="phonenum" value="<?= $phonenum; ?>" disabled>
                                
                                <div class="col-md-12 p-2">
                                    <button class="btn btn-lg btn-primary" type="submit" name="autodepo">Pay Booking Fee</button>
                                </div>
