...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <br>
            <?php
            $query = "SELECT users.id,users.fullname,users.phonenum,appointment.patient_id,appointment.appointmentdate 
            FROM users INNER JOIN appointment ON appointment.patient_id=users.id WHERE appointment.paid=1 ";
