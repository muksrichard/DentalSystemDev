...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <br>
            <?php
            $query = "SELECT prescription.id,users.fullname,prescription.prescript_name, prescription.prescript_qty,prescription.prescript_dosage FROM prescription 
            INNER JOIN consultation ON prescription.consultation_id=consultation.id
            INNER JOIN  users on users.id=consultation.patient_id WHERE users.id='$userid'";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <!-- <td>
                                                <a href="includes/action.php?view=<?php // $row['id']; ?>&page=appointments" class="badge badge-secondary p-2">Bill</a>
                                            </td> -->
                                        </tr>
                                    <?php } ?>
                                </tbody>
