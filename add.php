...
$sql1 = "SELECT id,fullname FROM users WHERE user_type='patient'";
          ...
          <form method="post" enctype="multipart/form-data" target="hidden_iframe" class="card card-sm">
            ...
            <div class="col">
              ...
              <div class="card-body row no-gutters align-items-center">
                <h6 class="col-md-6">Today is: <?= date("jS M  g:i a"); ?></h6>
                <a href="addpatients.php">
                  <h5 class="col-md-6 text text-gray-800">Register New Patient?</h5>
                </a>


                <h5 class="text text-gray-800">Patient Name :</h5>
                <select name="patient_id" class="form-control" id="exampleFormControlSelect1" required>
                  <?php

                  while ($row1 = $result1->fetch_assoc()) { ?>
                    <?php if ($row1['name'] == "default") { ?>
                ...
                <div class="col-md-12 p-2">
                  <button class="btn btn-lg btn-primary" type="submit" name="add_appointment">Add Appointment</button>
                </div>
