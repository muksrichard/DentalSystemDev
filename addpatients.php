...
if (!isset($_SESSION['email']) || $_SESSION['role'] != "reception") {
    # code...
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <div class="badge badge-secondary text-center col-md-4">
                <!-- Topbar Search -->
                <h3 class="h3 mb-0 text-white-800"> Add Patient</h3>
            </div>
            ...
            if (isset($_GET['a_success'])) { ?>
                <div class="row">
                    <div class="col-lg-12 alert alert-success alert-dismissible text-center">
                        ...
                        <b>Record Successfully added! Go to Appointments page to schedule patient </b>
                    </div>
                </div>
                <script>
                    window.history.pushState('page2', 'Title', 'addpatients.php');
                </script>
            <?php } ?>
                    ...
                    <form method="post" enctype="multipart/form-data" target="hidden_iframe" class="card card-sm">
                        ...
                        <div class="col">
                            ...
                            <div class="card-body row no-gutters align-items-center">
                                <h5 class="text text-gray-800">Patient Name :</h5>
                                <input class="form-control form-control-borderless text-dark" type="text" name="patient_name" value="<?php echo $patient_name; ?>" required>
                                <h5 class="text text-gray-800">Date of Birth:</h5>
                                <input class="form-control form-control-borderless text-dark" type="date" name="dob" value="<?php echo $dob; ?>" required>
                                ...
                                <h5 class="text text-gray-800">Address :</h5>
                                <input class="form-control form-control-borderless text-dark" type="text" name="address" value="<?php echo $address; ?>" required>


                                <div class="col-md-12 p-2">
                                    <button class="btn btn-lg btn-primary" type="submit" name="add_patient">Add</button>
                                </div>
