    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <div class="badge badge-secondary text-center col-md-4">
                <!-- Topbar Search -->
                <h3 class="h3 mb-0 text-white-800"> Payments </h3>
            </div>
        ...
        <div class="container">
            ...
            <br>
            <?php
            // $query = "SELECT prescription.id,patients.name,prescription.prescript_name, prescription.prescript_qty,prescription.prescript_dosage FROM prescription INNER JOIN consultation
            // ON prescription.consultation_id=consultation.id INNER JOIN patients on patients.id=consultation.patient_id ";
            $query = "SELECT users.id,appointment.patient_id,appointment.appointmentdate 
            FROM users INNER JOIN appointment ON appointment.patient_id=users.id WHERE appointment.paid=1 AND users.id='$userid'";
