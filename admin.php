...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
      ...
      <div class="badge badge-secondary text-center col-md-4">
        <!-- Topbar Search -->
        <h3> <a class="h3 mb-0 text-white" href="aprofile.php?profile=<?= $userid;
                                                                      ?>">My profile</a> </h3>
      </div>
      <!-- Topbar Navbar -->
          ...
          <form method="post" enctype="multipart/form-data" target="hidden_iframe" class="card card-sm">
            ...
            <div class="col">
              ...
              <div class="card-body row no-gutters align-items-center">
                <h6 class="col-md-12">Today is: <?= date("jS M  g:i a"); ?></h6>
                <a href="addusers.php">
                  <h5 class="col-md-12 text text-gray-800">Register New User?</h5>
                </a>
