    ...
    <div id="content">
        ...
        <div class="container">
            ...
            $query = "SELECT appointment.id,users.fullname, appointment.activity, appointment.appointmentdate FROM appointment
             INNER JOIN users ON users.id=appointment.user_id WHERE appointment.send=1 ORDER BY appointment.Dtime DESC";
            // $query="SELECT appointment.id,users.fullname, appointment.activity, appointment.appointmentdate FROM appointment
            //  INNER JOIN users ON users.id=appointment.user_id WHERE appointment.send=1  ORDER BY appointment.Dtime DESC";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="includes/action.php?view=<?= $row['id']; ?>&page=appointments" class="badge badge-secondary p-2">View</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
